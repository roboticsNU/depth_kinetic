...
public:
	...
	/**
	 * \brief Gets the position of the upper grabber in world
	 *        coordinates.
	 *
	 * \return The upper grabber position in 3D coordinates.
	 */
	virtual SK::Vector3 getUpperGrabberPosition3D() const;

	/**
	 * \brief Gets the position of the lower grabber in world
	 *        coordinates.
	 *
	 * \return The lower grabber position in 3D coordinates.
	 */
	virtual SK::Vector3 getLowerGrabberPosition3D() const;

	/**
	 * \brief Gets the position of the center grabber in world
	 *        coordinates.
	 *
	 * \return The center grabber position in 3D coordinates.
	 */
	virtual SK::Vector3 getCenterGrabberPosition3D() const;

	/**
	 * \brief  Gets a value indicating the relative "openness" of 
	 *		   the hand: 0.0f means completely closed and 1.0f means 
	 *         completely open.
	 *
	 * \return The openness.
	 */
	virtual float getOpenness() const;

	/**
	 * \brief  Gets a value indicating the handedness of 
	 *		   the hand: 0 is unknown, 1 is left, 2 is right.
	 *
	 * \return The openness.
	 */
	virtual int32_t getHandedness() const;
	...
	/**
	 * \brief Returns the posing gesture ID of the hand.
	 *
	 * \return An int representing the id of the current posing gesture.
	 */
	virtual const int32_t &getPosingGestureID() const;
